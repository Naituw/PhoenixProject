...
{
	if(!_ct_framesetter) {
        NSAttributedString * s = attributedString ? [[NSAttributedString alloc] initWithAttributedString:attributedString] : nil;
		_ct_framesetter = CTFramesetterCreateWithAttributedString((CFAttributedStringRef)s);
        [s release];
	}
